...
import EventManagementHeaderBg from '../../../assets/backgrounds/sector-header-bg.png'

export default function EventManagementHeader() {
  return (
    <div
      className="relative pt-10 bg-center bg-cover md:pt-20"
      style={{ backgroundImage: `url(${EventManagementHeaderBg})` }}
    >
      ...
      <div className="flex relative z-10 flex-col justify-center items-center py-10 text-sm text-white md:gap-6 md:py-20 md:text-base">
        <h1 className="text-2xl font-bold text-center md:text-5xl">Event Management</h1>
